...
<div id="mainDiv">
    ...
    <p>You can sign into Banner using your new password by going to <a
            href="http://selfservice.siena.edu">http://selfservice.siena.edu</a>.  After signing into Banner with this password you will be forced to change your password.<br/>
    </p>
    <g:form>
