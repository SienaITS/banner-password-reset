...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        //added grails spring webflow plug-in to enable workflow (webflow) functionality in controller
        //mcs for siena
        compile ":webflow:2.1.0"

        //added mail plugin to be able to send email from grails controller
        //mcs for siena
        compile ":mail:1.0.7"

        //added rest plugin to allow grails to use HTTPBuilder class to make HTTP requests in controller
        compile ":rest:0.8"
